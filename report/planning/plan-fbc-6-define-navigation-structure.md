...
-   [x] `src/app/(auth)/signin/page.tsx` renders a placeholder with proper heading and `<main>` landmark
-   [x] `src/app/(auth)/signup/page.tsx` renders a placeholder with proper heading and `<main>` landmark
-   [x] No business logic or Supabase calls in pages
-   [x] Uses DS components for headings/links; all styles via SCSS variables

**Definition of Done:**

-   [x] Lint/build pass
-   [x] Basic a11y landmarks verified (axe locally)
-   [x] Unit smoke test for rendering (if applicable)
...
-   [x] `src/app/dashboard/layout.tsx` defines `<nav>`, `<header>`, `<main>` landmarks
-   [x] Add skip link and accessible names via `shared/a11y/`
-   [x] Navbar/Sidebar and Header placeholders use DS components and SCSS variables
-   [x] Responsive structure without layout shifts

**Definition of Done:**

-   [x] Lint/build pass
-   [x] Axe check for landmarks and roles
...
-   [x] `RestrictedPage` lives in `src/presentation/components/` and only orchestrates auth state
-   [x] Reads auth status from provider/store; redirects or shows link to `/signin` when not authenticated
-   [x] No Supabase calls; no business logic
-   [x] Keyboard-focus-friendly redirect/announcement for denied access (aria-live polite)

**Definition of Done:**

-   [x] Lint/build pass
-   [x] Basic unit test for rendering behavior with mocked auth state
-   [x] A11y announcement present for state change
...
-   [x] `src/app/dashboard/page.tsx` renders placeholder content and heading
-   [x] `src/app/dashboard/stats/page.tsx` renders placeholder content and heading
-   [x] `src/app/dashboard/activities/page.tsx` renders placeholder content and heading
-   [x] `src/app/dashboard/catalog/page.tsx` renders placeholder content and heading
-   [x] All pages render within dashboard layout and `RestrictedPage`

**Definition of Done:**

-   [x] Lint/build pass
-   [x] A11y landmarks intact in each page
-   [x] No business logic; no inline styles
...
-   [x] Navbar/Sidebar includes links to `/dashboard`, `/dashboard/stats`, `/dashboard/activities`, `/dashboard/catalog`
-   [x] Active route is visually indicated; styles from SCSS variables
-   [x] Links include appropriate aria-current and accessible names

**Definition of Done:**

-   [x] Lint/build pass
-   [x] Keyboard navigation tested (Tab/Shift+Tab)
-   [x] Axe passes for nav roles and labels
